...
```{r setup, results = 'hide', message=FALSE, warning=FALSE, cache=FALSE, echo = TRUE, include = TRUE, fig.keep='all'}
...
```{r Validation by Line, results = 'asis'}
# Validation by Line
...
test %>% # TRAIN ID
  ...
  kable(title = "Train ID and average delay time by Line", caption = "Top 20 Train IDs with Highest Delays by Avg Delay Time (Figure 5.4)") %>% kable_styling("striped",full_width = F)
...
# Authors Note
There was some difficulty in exporting this analysis as an R Markdown as options would either show results or hide tables. Please excuse unnecessary warnings and results in the markdown. 
